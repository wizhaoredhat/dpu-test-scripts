...
require (
	...
	github.com/openshift/dpu-operator v0.0.0-20240416202150-049bed263869
...
require (
	...
	github.com/vishvananda/netlink v1.2.1-beta.2.0.20230905152006-63484bbf69f8 // indirect
